...
//Search the corresponding article ID according to the article tittle
 ...
 */
int db_update_postings(const wiser_env *env, int token_id, int docs_count,
 ...
 */
int db_get_settings(const wiser_env *env, const char *key, int key_size,
